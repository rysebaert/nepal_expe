...
# Prep data
peaks <- st_read("peak_6700_geoloc.geojson")
...
# Peak data ----
peaks_df <- read.dbf("data/peaks.DBF")
...
# Export
st_write(peaks, "peak_6700_geoloc_data.geojson")


# Members data ----
members <- read.dbf("data/members.DBF")
